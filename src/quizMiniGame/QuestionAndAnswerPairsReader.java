...
/**
 * The Class QuestionAndAnswerPairsReader, which reads question and answer pairs from an XML document
 */
public class QuestionAndAnswerPairsReader implements Serializable {
	 ...
	 *
	 * @return the question and answer pairs document read from XML
	 */
